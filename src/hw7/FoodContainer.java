...
public abstract class FoodContainer {
    // Использовать сеттеры и геттеры для получения родительских полей это все-таки ненормально))
    // Буду считать, что я вынес иерархию животных в отдельный пакет
    // Поэтому поля сделяю protected
    protected double
            capacity,
            foodVolume;
